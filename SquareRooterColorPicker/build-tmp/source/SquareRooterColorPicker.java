...
public class SquareRooterColorPicker extends PApplet {
...
public void draw() {
  ...
  if(img !=null) 
  {
    ...
    if(dropCt == 11) 
    {
      ...
      boxW = PApplet.parseInt( (width/colors.size())-TWO_PI );
      boxH = PApplet.parseInt( (height/colors.size())-TWO_PI );
...
public ArrayList<Integer> suck(PImage img)
{
/////////
int root1, root2;
int sum1 = 0;
...
public void dropEvent(DropEvent theDropEvent) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SquareRooterColorPicker" };
    if (passedArgs != null) {
