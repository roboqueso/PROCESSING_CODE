...
drawLissajous( xx1, yy1, frameCount/TWO_PI );  //  PI  
evenOddFill(0);//  #EF2012
...
//  fill(#20EF12);
//  text( int( a)+"|"+ int(b)+"|"+int(amp), a-amp, b+amp );
}
...
void exit() 
{
  ...
  artDaily("Never give up... and never surrender"+ getTimestamp() );
