...
public class SphereThing3 extends PApplet {
...
public void drawSuns2(float xx, float yy) {
...
// draw circles
  while ( angle1 < 2160 ) {
    ...
    stroke( 0xffEFEFEF, alf);  // 19EF75  EFAA36
...
//      stroke( #EFEF36, (alf*2));  // random(111)
    ...
    strokeWeight( random(1.99f) );
    line( xx1, yy1, xx2, yy2);
    
    stroke( 0xffB00B13, pow(alf,3) );  // EF1936  random(111)
    strokeWeight( random(4.2f) );
    point( xx1, yy1 );
...
public void artDaily( String dailyMsg ) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SphereThing3" };
    if (passedArgs != null) {
