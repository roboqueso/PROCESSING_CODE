...
String artDailyMsg = "ERICFICKES.COM";  //"rotateY";  //"rotateZ";  //"no rotate+";  //
//  
float alf = 69;
...
//  rotateZ(frameCount);
    ...
    //  RUN A SERIES WITH ALL -, THEN ALL +
    xx1 = startX1+frameCount+cos( radians( frameCount ) ) * alf;
    yy1 = startY1+frameCount+sin( radians( frameCount ) ) * alf;
    ...
    stroke(random(111) );
    point( xx1, yy1, frameCount*PI );
    point( yy1, xx1, frameCount*PI );
