...
String outFileName = "monTRI020612";  //don't add extension
...
//  grid settings
int shapeSize = 37;
// Sierpinski.pde by Martin Prout
float T_HEIGHT = sqrt(3)/2; 
float TOP_Y = 0;
float BOT_Y = this.height;
...
///////////////////////////////////////////////////////////
//  /\
void drawTriangle(float cx, float cy, float sz)
{
  float cx0 = cx;
  float cy0 = cy - TOP_Y * sz;
  float cx1 = cx - sz/2;
  float cy1 = cy + BOT_Y * sz;
  float cx2 = cx + sz/2;
  float cy2 = cy + BOT_Y * sz;
