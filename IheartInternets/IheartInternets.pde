...
for( int xx = 0 ; xx <= htSize; xx += blockSize ) {
//  line( x+xx, y, x+xx, htSize+y );
//  line( x, y+xx, htSize+x, y+xx );
  
  line( x+xx, 0, x+xx, height );
  
  line( 0, y+xx, width, y+xx );
}
//  GRID
...
//TODO: Drop the black side one more block
