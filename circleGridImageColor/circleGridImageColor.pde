...
//  Extract colors from external image and fill in circles using that palette
import fixlib.*;
...
String dailyMsg = "ART DAILY 2.7.18"; // og 2012
...
//  img = loadImage( "adobeFX4.jpg" );
  ...
  //   }
  // }
  _colors = fix.getImgColors( img, true);
...
void imgColorStroke() {
  fix.ranPalStroke(_colors);
}

//  stroke a random color out of loaded image
void imgColorFill() {
  fix.ranPalFill(_colors);
}
