...
void setup()
{
	...
	r1.strokeWeight(1).stroke(#181818).noFill().loc(0,0);
	rects.add(r1);
	...
	r2.strokeWeight(1).stroke(#181818).noFill().loc(colW+15,0);
	rects.add(r2);
	...
	r3.strokeWeight(1).stroke(#181818).noFill().loc(colW*2+30,0);
	rects.add(r3);
	...
	r4.strokeWeight(1).stroke(#181818).noFill().loc(colW*3+45,0);
	rects.add(r4);
	...
	r5.strokeWeight(1).stroke(#181818).noFill().loc(colW*4+60,0);
	rects.add(r5);
