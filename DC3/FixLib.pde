...
class FixLib {
  ...
  //  SAY /////////////////////////////////////////////////////////////////////
  //  * OSX only
  //  TODO: find say replacement for windows
  public void say(String msg){
    String sayThis = ( "" == trim(msg) ) ? "All done sir" : msg;
    String[] cmd = { "/usr/bin/say", sayThis };
    exec(cmd);
  }
  ...
  //  color[]
  public void p3Grid( ArrayList pall ) {
  ...
  ////////////////////////////////////////////////////
  //  Return a random color from supplied p3
  public color getRanColor(ArrayList p3)
  {
    return (Integer)p3.get( (int)random( p3.size()-1 ) );
  }
  
  
  ////////////////////////////////////////////////////
  //  Randomly stroke using image from color list
  public void ranPalStroke(color[] p3)
  {
    // pallete
    stroke( p3[ int(random( p3.length-1 )) ], alf );
  }
  public void ranPalStroke(ArrayList p3)
  {
    // pallete
    stroke( (Integer)p3.get( (int)random( p3.size()-1 ) ), alf );
  }
  public void ranPalStroke100(color[] p3)
  {
    // pallete
    stroke( p3[ int(random( p3.length-1 )) ], 100 );
  }
  public void ranPalStroke100(ArrayList p3)
  {
    // pallete
    stroke( (Integer)p3.get( (int)random( p3.size()-1 ) ), 100 );
  }
  public void ranPalFill(color[] p3)
  {
    fill( p3[ int(random( p3.length-1 )) ], alf );
  }
  public void ranPalFill(ArrayList p3)
  {
    // pallete
    fill( (Integer)p3.get( (int)random( p3.size()-1 ) ), alf );
  }
  public void ranPalFill100(color[] p3)
  {
    // pallete
    fill( p3[ int(random( p3.length-1 )) ], 100 );
  }
  public void ranPalFill100(ArrayList p3)
  {
    // pallete
    fill( (Integer)p3.get( (int)random( p3.size()-1 ) ), 100 );
  }
