...
/*    RSU();
    ...
    point( random(dist( xx1, yy2, xx3, yy4 )), random(dist( xx3, yy3, xx4, yy5 )) );  */
...
//    point( dist( xx1, yy2, xx3, yy4 ), dist( xx3, yy3, xx4, yy5 ) );
  ...
  if( frameCount % 4 == 0 ) {
     rect( random(xx1, xx2), yy1, alf*2, alf*2, random(TWO_PI) );
     rect( random(xx2, xx3), yy2, alf*2, alf*2, random(TWO_PI) );
  } else {
