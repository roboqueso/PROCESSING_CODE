...
public class CameraDrawer3 extends PApplet {
...
public void draw() {
  if (cam.available()) 
  {
    ...
    a = new PVector( xx-sz, yy, sz+noise(frameCount*.1f) );
    b = new PVector( xx, yy-sz, sz+noise(frameCount*.2f)  );
    c = new PVector( xx+sz, yy, sz+noise(frameCount*.3f)  );
    d = new PVector( xx, yy+sz, sz+noise(frameCount*.4f)  );
...
switch(key){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "CameraDrawer3" };
    if (passedArgs != null) {
