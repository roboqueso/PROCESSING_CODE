//  SEE:   https://ello.co/ericfickes/post/odinlqmzyqfit6rbjqlovg
...
void setup() {
  ...
  // init 
  radius1 = random(250,500);
  radius2 = random(350, 700);
  
  radius3 = random(420,840);
  radius4 = random(333,666);
  radius5 = random(420,999);
  
  startX1 = startX2 = startX3 = startX4 = startX5 = x;
  startY1 = startY2 = startY3 = startY4 = startY5 = y;

  angle1 = angle5 = random(25);
  angle2 = random(69);
  angle3 = random(96);
  angle4 = random(90,250);  //200;

  maxCt = 4;//width+height;
...
void draw()
{
    ...
    fix.ranPalStroke( boobColors );
    fix.drawLissajous( xx1, yy1, ct );
    
    fix.ranPalStroke( palette );
    fix.drawLissajous( xx2, yy2, ct );
    
    fix.ranPalStroke( palette );
    fix.drawLissajous( xx3, yy3, ct );
    
    fix.ranPalStroke( palette );
    fix.drawLissajous( xx4, yy4, ct );
    
    fix.ranPalStroke( palette );
    fix.drawLissajous( xx5, yy5, ct );
...
void artDaily( String dailyMsg ) {
  ...
  fill(#676800);
  text( " "+dailyMsg, width-430, height-14);
/*
float yy = 0;
while( yy <= height ) {
