...
public class TuesTue_cam3 extends PApplet {
...
public void draw()
{
  xx = cX - PApplet.parseInt( cos(radians( frameCount )) * radSz+noise(frameCount) );
  yy = cY - PApplet.parseInt( sin(radians( frameCount )) * radSz+noise(frameCount) ); 
...
switch(key){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "TuesTue_cam3" };
    if (passedArgs != null) {
