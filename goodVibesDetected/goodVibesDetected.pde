...
//  distance patterns
  ...
  dx  = dist( xx1, xx2, yy1, yy2 );
  dy  = dist( xx2, xx5, xx3, yy4 );
...
curve( xx1, xx2, xx3, yy4, xx5, yy3, xx4, yy4 );

ranPalStroke( palette3 );
curve( xx2, yy2, xx3, yy3, xx4, yy4, xx5, yy5 );
*/
