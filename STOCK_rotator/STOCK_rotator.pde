...
float cX, cY, x, y;
int preScale = 1;
int inc = 9;	//15;	// rotate angle incrementor ( this many += up until 361 )
...
//	HACKY - but helps with saving MODEL_NAME to output png
// String MODEL_PATH = "../_allmodelsP5/201384220/";
// String MODEL_NAME = "thermos_289.obj";
...
String MODEL_PATH = "../_allmodelsP5/207432973/";  String MODEL_NAME = "hexagonal_display_structure_1411.obj";
...
void doExit(){
  ...
  save( fix.pdeName() + "-"+ MODEL_NAME.toUpperCase() + "_" + preScale + "_" + inc + "_" + lights + "_" + fillStyle + "-" + fix.getTimestamp()+".png" );    //  USE .TIF IF COLOR  
