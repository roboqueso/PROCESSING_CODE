...
fix.ranPalStroke100( boobColors );//ranPalStroke( boobColors );//stroke(#ef0000,alf);
//point( xx2, yy3 );
//ellipse( xx2, yy4, ( angle3/radians(radius2) ), ( angle3/radians(radius2) ) );
...
//stroke(0, alf);//, alf);  // 0
line( xx5, yy1, ( angle3/radians(radius3) ), ( angle3/radians(radius3) ) );

//strokeWeight( .25 );
//ranPalStroke( boobColors );
//ranPalStroke( boobColors );//stroke(0, 75);//alf/2);
//point( xx2, yy3, ( angle2/alf ), ( angle2/alf ) );
//line( xx5, yy4, xx2, yy3);

//strokeWeight(.5);
//ranPalStroke( boobColors );
//line( xx1, yy2, xx2, yy3 );
//ranPalStroke( boobColors );
//line( xx3, yy4, xx4, yy5 );
//ranPalStroke( boobColors );
//line( xx4, yy5, xx5, yy1 );
