...
public class CameraDrawer12 extends PApplet {
...
//  RE-UP SNAP
  ...
  beginShape();
    ...
    vertex(d.x, d.y, sz, sz );
		...
		bezierVertex(a.x, a.y, b.x, b.y-sz, b.x, b.y+sz );
		// bezierVertex(b.x, b.y, c.x, c.y+sz, c.x, c.y-sz );
		// bezierVertex(c.x, c.y, d.x, d.y-sz, d.x, d.y+sz );
		bezierVertex(d.x, d.y, a.x, a.y-sz, a.x, a.y+sz );
...
switch(key){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "CameraDrawer12" };
    if (passedArgs != null) {
