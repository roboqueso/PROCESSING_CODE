...
int dotSize     = 30;  //16;  // size of ellipse used to draw sine wave
int xspacing    = 20, yspacing = xspacing;   // How far apart should each horizontal location be spaced
