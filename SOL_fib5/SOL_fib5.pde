...
//  
color[] p1 = { 
#EF0000, #EFEF00, #000036, #EF0000, #00EF00, #0000EF, #EFEFEF, #A59DA1, #D96D55, #F36613, #A9ABEA, #D23301, #F6FAFD, #AB6E9C, #D6F9FF, #F8751E, #768A00, #F05510, #FFEE51, #FFB02A, #D7D5FA
};
...
void draw()
{
  ...
  if( frameCount % 6 == 0 ) {
    ...
    {    
      ...
      line( xx, yy, outerXX, random(yy,outerYY) );
