...
void draw()
{
  ...
  for(int i=0;i<userList.length;i++)
  {
    ...
    {
      // sphereDetail((int)random(PI,TWO_PI));
      sphereDetail(
    ...
    noStroke();
    textureWrap(REPEAT);
    tint(com.x, com.y, com.z);

    beginShape(TRIANGLES);//QUAD_STRIP);  //   POINTS, LINES, TRIANGLES, TRIANGLE_FAN, TRIANGLE_STRIP, QUADS, or QUAD_STRIP
    ...
    if(frameCount%30==0){
      ...
      fill(com.y%255,com.x%255,com.z%255);
