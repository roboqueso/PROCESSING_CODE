...
void draw()
{
  ...
  AddPt(com);
        ...
        beginShape();
          ...
          curveVertex(com.x - 15,com.y,com.z ); 
          curveVertex(com.x + 15,com.y,com.z );
          
          curveVertex(com.x,com.y - 15,com.z);
          curveVertex(com.x,com.y + 15,com.z);

          curveVertex( com.x, com.y, com.z);
  ...
  beginShape(POLYGON);
  	...
  	tint( random(frameCount%width), random(frameCount%height),random(frameCount%255));
  	texture(imgTexture);
