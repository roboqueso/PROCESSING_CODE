...
void setup()
{
  ...
  size( context.depthWidth()*4, context.depthHeight()*4, P3D);
 }
...
imgTexture2 = context.depthImage();
      ...
      for(int y=0;y < context.depthHeight();y+=steps)
      {
        ...
        for(int x=0;x < context.depthWidth();x+=steps)
        {
          ...
          { 
            ...
            if(userMap[index] == 0)
            {
              // point(realWorldPoint.y,realWorldPoint.x, realWorldPoint.z/steps, realWorldPoint.y, realWorldPoint.x);
    ...
    for(int x=0;x < context.depthWidth();x+=steps)
    {
      ...
      { 
        ...
        if(userMap[index] != 0)
        {
          ...
          strokeWeight(realWorldPoint.z/1000);
