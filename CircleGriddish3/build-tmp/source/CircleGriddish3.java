...
public class CircleGriddish3 extends PApplet {
...
// draw circles
  while ( angle1 < 1080 ) {
    ...
    // inner
    stroke( 0xffACE511, alf*2);  //  #EFEFEF  #ACE511
    //fix.ranPalStroke(palette);
    strokeWeight( random(6.9f) );
    line( xx1, yy1, xx2, yy2 );

    // outer
    stroke( random(111), pow(alf,1.75f));
//  #ACE511
...
//  fill(#EE0000);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "CircleGriddish3" };
    if (passedArgs != null) {
